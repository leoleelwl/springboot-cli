...
public class UserController extends BaseController {
    ...
    public void addUser(@Valid User user) throws AppException {
        try {
    ...
    public void updateUser(@Valid User user) throws AppException {
        try {
    ...
    public void deleteUsers(@NotBlank(message = "{required}") @PathVariable String userIds) throws AppException {
        try {
    ...
    @PutMapping("profile")
    public void updateProfile(@Valid User user) throws AppException {
        try {
    ...
    public void updateAvatar(
            ...
            @NotBlank(message = "{required}") String avatar) throws AppException {
        try {
    ...
    public void updateUserConfig(@Valid UserConfig userConfig) throws AppException {
        try {
    ...
    public void resetPassword(@NotBlank(message = "{required}") String usernames) throws AppException {
        try {
    ...
    public void export(QueryRequest queryRequest, User user, HttpServletResponse response) throws AppException {
        try {
