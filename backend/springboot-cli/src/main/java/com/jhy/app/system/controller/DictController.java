...
import com.jhy.app.system.domain.Dict;
import com.jhy.app.system.service.DictService;
...
public class DictController extends BaseController {
    ...
    public void addDict(@Valid Dict dict) throws AppException {
        try {
    ...
    public void deleteDicts(@NotBlank(message = "{required}") @PathVariable String dictIds) throws AppException {
        try {
    ...
    public void updateDict(@Valid Dict dict) throws AppException {
        try {
    ...
    public void export(QueryRequest request, Dict dict, HttpServletResponse response) throws AppException {
        try {
