...
import com.jhy.app.system.domain.Test;
import com.jhy.app.system.service.TestService;
...
public class TestController extends BaseController {
     ...
     */
    @PostMapping("import")
    public ResponseBean<?> importExcels(@RequestParam("file") MultipartFile file) throws AppException {
        try {
            if (file.isEmpty()) {
            ...
            if (!StringUtils.endsWith(filename, ".xlsx")) {
                throw new AppException("只支持.xlsx类型文件导入");
            }
            // 开始导入操作
     ...
     */
    @PostMapping("export")
    public void export(HttpServletResponse response) throws AppException {
        try {
