...
public class DeptController extends BaseController {
    ...
    public void addDept(@Valid Dept dept) throws AppException {
        try {
    ...
    public void deleteDepts(@NotBlank(message = "{required}") @PathVariable String deptIds) throws AppException {
        try {
    ...
    public void updateDept(@Valid Dept dept) throws AppException {
        try {
    ...
    public void export(Dept dept, QueryRequest request, HttpServletResponse response) throws AppException {
        try {
